...
const Hero = () => {
  return (
    ...
    <div className=' m-auto my-auto grid grid-cols-2 gap-72 place-items-center bg-black  h-[580px] w-[1200px]'>
        <div className='col-span-1'>
        <h1 className=' font- sans-serif text-6xl font-bold bg-gradient-to-r from-purple-500  to-cyan-500 text-transparent bg-clip-text'>AI Marketing.</h1>
        <h1 className='font- sans-serif text-6xl font-bold text-white'> Optimized Reach. </h1> <br/>
        ...
        <img className=' col-span-1' src="../../src/assets/heroimage.png" alt="ini gambar" />
        </div>
